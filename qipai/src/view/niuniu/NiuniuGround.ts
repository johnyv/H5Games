class NiuniuGround extends eui.Component implements eui.UIComponent {
	...
	private enterGame_Now(baseNum, minEkt): void {
		...
		this._channel.postCommand(ConstData.NIUNIU_BATTLE_CONTROLLER, ConstData.BATTLE_NIU_MATCH_PLAYERS);
	}

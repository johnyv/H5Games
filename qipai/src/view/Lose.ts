class Lose extends eui.Component implements eui.UIComponent {
	...
	public init(): void {
		...
		this._channel.postCommand(ConstData.SOUND_CONTROLLER, ConstData.SOUND_PLAY_MUSIC, ['fail_snd_mp3', 1]);
	}
	...
	*/
	...
	private continue(): void {
		...
		this._channel.postCommand(ConstData.UI_CONTROLLER, ConstData.UI_REMOVE_VIEW_BY_NAME, [ConstData.LOSE_VIEW]);
		// this._channel.postCommand(ConstData.UI_CONTROLLER,ConstData.UI_REMOVE_ALL_VIEW);

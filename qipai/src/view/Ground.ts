class Ground extends eui.Component implements eui.UIComponent {
	private _channel: CommandChannel;
	private ekt_txt: eui.Label;
	private primary: eui.Button;
	private middle: eui.Button;
	...
	public init(): void {
		...
		this._channel.postCommand(ConstData.SOUND_CONTROLLER, ConstData.SOUND_PLAY_MUSIC, ['ground_snd_mp3']);
		this.addSpark(this.primary);
		this.addSpark(this.middle);
	...
	private enterGame_Now(baseNum, minEkt): void {
		...
		this._channel.postCommand(ConstData.GAME_CONTROLLER, ConstData.GAME_SET_PLAYER, { 'minEkt': minEkt });
